...
def play_best_of(n):
    # play against computer until someone wins best of n games
    ...
    while player_wins < wins_necessary and computer_wins < wins_necessary:
        ...
        # tie
        if result == 0:
            print("It's a tie! You and the computer have both chosen {}".format(user))
        # you win
        elif result == 1:
            player_wins += 1
    ...
    if player_wins > computer_wins:
        ...
        print("Unfortunately, the computer has won the best of {} games. Try again later.".format(n))

if __name__ == '__main__':
    play_best_of(int(input("How many rounds do you feel up for?\n")))